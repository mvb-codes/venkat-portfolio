      ...
      <div className="grid-container">
        ...
        <div className="space-y-3">
          ...
          <p className="grid-subtext">
            I’m a Computer Science grad student who enjoys learning new technologies and building 
            things that make life a little easier. I’ve worked on projects ranging from radar research 
            to web apps, and I’m now looking for opportunities to grow through real-world experience.
          </p>
        </div>
      </div>
    </div>
