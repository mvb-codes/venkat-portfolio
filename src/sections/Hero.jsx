      ...
      <div className="md:w-3/4 w-full sm:flex justify-center items-center sm:mt-20 mt-20 c-space">
        <div className="w-full mx-auto flex flex-col">
          ...
          <span className="text-white font-medium leading-8 sm:mt-22 mt-5">
            🌱 Aspiring Software Engineer and curious problem-solver, eager to learn and grow through hands-on experiences. Dedicated to turning ideas into practical solutions that make an impact. 🚀
          </span>
